...
public class RecordUploadClient {
    ...
    private int executeRequestWithRetry(int times,
        ...
        try {
            ...
            long actual_per_resquest_elapsedTime = endTime - startTime;

            // Uncomment the following 2 lines for visible output.
            // Comment for better client speed
//            System.out.println(Thread.currentThread().getName() + "got response code: " + response.getStatusCode());
//            System.out.println("Actual per request elapsed time in milliseconds is " + actual_per_resquest_elapsedTime);
